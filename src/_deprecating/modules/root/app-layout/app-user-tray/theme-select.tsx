...
export function AppUserTrayThemeSelect() {
  ...
  useEffect(() => {
    ...
    setActiveAccentColor(account.app_config?.accent_color ?? "sml-gold")
  }, [account, activeAccentColor, setActiveAccentColor])

  const selectedAccentColor: AccentColorKey = account?.app_config?.accent_color ?? "sml-gold"
